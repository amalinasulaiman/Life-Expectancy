...
lifeExp2 <- readr::read_csv('data/lifeExp2.csv')
...
shinyUI(
  ...
  tabItems(
    ...
    tabItem(tabName = "dashboard", fluidRow(h1("Welcome to my R Shiny Dashboard!"),
            mainPanel(column(width=12, 
"This dashboard is designed based on data set that has been obtained 
from TidyTuesday and GapMinder."),
box(width = 12,height = 50,column(width =12,"What I've learned from the data:")),
